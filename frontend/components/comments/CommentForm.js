...
class CommentForm extends React.Component {
  ...
  // "&& Object.keys(this.props.commentFormInfo).length checks if object isn't empty because after successful reply submission
  // commentFormInfo is reset to empty object which triggers componentDidUpdate method and in this case it's not needed
  componentDidUpdate(prevProps) {
    if (this.props.commentFormInfo !== prevProps.commentFormInfo && Object.keys(this.props.commentFormInfo).length) {
      let text;
      if (this.props.commentFormInfo.text) {
